...
// update data sesuai dengan input user
if(isset($_GET['id_status'])){
	$otask->update($_GET['id_status']);
	header("location:index.php");
}
...
// sorting secara ascending dan memanggil fungsi yang sudah dibuat
if(isset($_GET['sorting'])){
	$otask->sorting($_GET['sorting']);
}
